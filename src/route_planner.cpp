...
float f2 = b->g_value + b->h_value; //calculate f value for second node

return f1 > f2; //return true flag if f vale of first node is greater than the second
}

RouteModel::Node *RoutePlanner::NextNode() {
    
    // - Sort the open_list according to the sum of the h value and g value.
    std::sort(open_list.begin(), open_list.end(), CompareFunction);
...
void RoutePlanner::AStarSearch() {
    ...
    // TODO: Implement your solution here.
    current_node = start_node; // initialize current_node with the starting node
